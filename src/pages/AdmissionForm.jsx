...
export default function AdmissionForm({ onBack }) {
  ...
  const validateStep = (s) => {
    ...
    if (s === 0) {
      ...
      if (!form.phone.trim()) err.phone = "Phone number is required";
        ...
        err.phone = "Please enter a valid 11-digit phone number";
    } else if (s === 1) {
      if (!form.qualification.trim())
        err.qualification = "Last qualification is required";
  ...
  const handleCropComplete = (croppedDataUrl) => {
    ...
    fetch(croppedDataUrl)
      .then((r) => r.blob())
      .then((blob) => {
        const croppedFile = new File([blob], "student_photo.jpg", {
          type: "image/jpeg",
        });
        setForm((prev) => ({
          ...prev,
          ...
          >
            ...
            <div className="bg-slate-50/80 border border-slate-100 rounded-2xl p-4 flex flex-col sm:flex-row items-center gap-5">
              ...
              <div className="relative flex-shrink-0">
                ...
                >
                  {form.photoPreview ? (
                    ...
                    <>
                      <div
                        className={`w-10 h-10 rounded-full ${errors.photo ? "bg-red-100 text-red-500" : "bg-blue-50 text-blue-600"} flex items-center justify-center group-hover:scale-110 transition-transform`}
                      >
                        <Camera className="w-5 h-5" />
                      </div>
                      <span
                        className={`text-[10px] font-bold mt-1 ${errors.photo ? "text-red-400" : "text-slate-400"}`}
                      >
                        Upload
                      </span>
                    </>
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-slate-400 text-xs mt-1 leading-relaxed">
                  Upload a clear passport size photograph (PNG, JPG up to 5MB)
                  for student ID card generation.
                </p>
                <button
                  type="button"
                  onClick={() => fileInputRef.current?.click()}
            ...
            <div className="relative">
              ...
              >
                ...
                <span
                  className={`flex-1 text-sm font-semibold ${form.gender ? "text-slate-800" : "text-slate-400"}`}
                >
                ...
                <div className="absolute left-0 right-0 top-full mt-1.5 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden z-50">
                  {[
                    ...
                    return (
                      ...
                      >
                        <GenderIcon
                          className={`w-4 h-4 ${value === "Male" ? "text-blue-500" : "text-pink-500"}`}
                        />
          ...
          >
            ...
            <CustomDropdown
              ...
              options={[
                ...
                {
                  value: "whatsapp",
                  label: "WhatsApp / Friend recommendation",
                },
            ...
            <div className="flex items-center gap-3 bg-blue-50/50 border border-blue-100 rounded-xl p-4 mt-2">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, whatsappGroup: e.target.checked })
                }
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Please double check your credentials before submitting.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                return (
                  <div
                    key={item.label}
                    className="bg-slate-50/70 border border-slate-100 rounded-xl p-4 flex gap-3"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-slate-800 font-semibold text-xs mt-0.5 leading-relaxed">
                        {item.value}
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex items-start gap-3 mt-2">
              ...
              >
                ...
                authentic. I agree to abide by Shine Tech Academy's terms &
                conditions.
              </label>
            </div>
          </motion.div>
      ...
      <div className="min-h-screen bg-transparent relative z-10 flex flex-col">
        ...
        <div className="sticky top-0 z-50 bg-white/40 backdrop-blur-md border-b border-slate-100/50">
          <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
            <button
              onClick={onBack}
              className="flex items-center gap-1.5 text-slate-500 hover:text-slate-800 transition-colors text-sm font-medium self-center"
            >
            ...
            <div className="flex flex-col items-center gap-0 self-center">
              ...
              />
              <span className="font-space font-bold text-[10px] text-slate-800">
                Admission Form
              </span>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-3 sm:px-4 py-6 sm:py-10 w-full flex-1 flex flex-col justify-center relative z-20">
          ...
          <div className="flex justify-between mb-8">
            {STEPS_LABELS.map((l, i) => (
              <span
                key={l}
                className={`text-[11px] font-semibold uppercase tracking-wider transition-colors hidden sm:block ${i <= step ? "text-blue-600" : "text-slate-300"}`}
              >
                {l}
              </span>
            ))}
