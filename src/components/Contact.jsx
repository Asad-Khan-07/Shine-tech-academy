    ...
    <section id="contact" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-slate-50/60 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          >
            <h3 className="font-space font-bold text-xl text-slate-900">Reach Us Anytime</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Have a question about admissions or courses? We're here to help. Reach us via WhatsApp, email, or visit our campus.
            </p>
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                },
                {
                  icon: MapPin,
                  label: 'Address',
                  value: 'Shine Tech Academy, Your City, Pakistan',
                  href: '#',
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 sm:p-7 lg:p-8">
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  <h3 className="font-space font-extrabold text-xl text-slate-900 mb-1">Send a Message</h3>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className="form-input rounded-xl px-4 py-3 text-sm resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="btn-primary py-4 rounded-xl text-sm font-bold flex items-center justify-center gap-2 mt-1 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
