...
/* ─── Aurora Fluid Glow Component (Layered on top of white overlay) ───── */
function AuroraFluidGlow() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-[2]">
      {/* Glow Blob 1 - Indigo/Blue (Top-Left area, extremely vibrant) */}
      <motion.div
        className="absolute w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-blue-500/25 to-indigo-600/25 blur-[120px]"
        animate={{
          x: [0, 80, -40, 0],
          y: [0, -60, 50, 0],
          scale: [1, 1.15, 0.9, 1],
      ...
      {/* Glow Blob 2 - Cyan/Blue (Bottom-Right area) */}
      <motion.div
        className="absolute w-[500px] h-[500px] rounded-full bg-gradient-to-br from-cyan-400/20 to-blue-500/20 blur-[100px]"
        animate={{
          x: [0, -70, 50, 0],
          y: [0, 50, -60, 0],
          scale: [1, 0.85, 1.1, 1],
      ...
      {/* Glow Blob 3 - Light Violet (Middle area) */}
      <motion.div
        className="absolute w-[450px] h-[450px] rounded-full bg-gradient-to-r from-violet-500/18 to-purple-600/15 blur-[90px]"
        animate={{
          x: [0, 50, -30, 0],
          y: [0, -40, 40, 0],
        }}
...
export default function Hero({ onApply }) {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center pt-8 sm:pt-0 overflow-hidden"
    >
      ...
      {/* Gradient overlays (White covers bottom z-index) */}
      ...
      {/* ── Aurora & Fluid Neon Glow (Placed above white overlay at z-[2]) ── */}
      <AuroraFluidGlow />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Headline */}
            <motion.h1
              className="font-space font-extrabold text-slate-900 text-4xl sm:text-5xl md:text-[56px] leading-[1.1]"
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                href="#apply"
                className="btn-primary px-8 py-3.5 rounded-full text-sm sm:text-base shadow-xl shadow-blue-500/30 flex items-center gap-2"
              >
              ...
              <motion.button
                ...
                className="relative bg-white hover:bg-slate-50 text-slate-800 font-bold px-8 py-3.5 rounded-full text-sm sm:text-base transition-all flex items-center gap-2 border border-slate-200 hover:border-blue-200 shadow-md hover:shadow-lg hover:shadow-blue-500/10"
              >
                <Sparkles className="w-4 h-4 text-blue-500" /> Book FREE Demo
              </motion.button>
            </motion.div>
          ...
          >
            {/* Main image card */}
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white w-full max-w-lg aspect-[4/3] animate-glow-blue">
              <img
                src={classroomImage}
              ...
              />
              {/* Overlay badge */}
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-3 flex items-center gap-3 shadow-lg border border-white/80">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-lg flex items-center justify-center text-white flex-shrink-0 shadow-lg">
            ...
            <FloatingBadge
              delay={0.9}
              className="absolute -top-4 -right-4 bg-white rounded-2xl px-4 py-3 shadow-xl border border-blue-50 flex items-center gap-2 hidden lg:flex"
            >
            ...
            <FloatingBadge
              delay={1.1}
              className="absolute -bottom-4 -left-4 bg-white rounded-2xl px-4 py-3 shadow-xl border border-blue-50 flex items-center gap-2 hidden lg:flex"
            >
              ...
              <div>
                ...
                <p className="text-slate-900 font-extrabold text-sm">⭐ 5.0 / 5.0</p>
              </div>
            </FloatingBadge>
          </motion.div>
