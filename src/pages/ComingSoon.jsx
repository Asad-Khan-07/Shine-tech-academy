...
import { Rocket, Mail, CheckCircle, Sparkles, ArrowRight, Lock, BookOpen, Code2, Award, Copyright } from 'lucide-react'
...
const LinkTreeIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    <path d="M12 0C9.2 0 6.8 2.4 6.8 5.2v4.4c0 1.6 1.2 2.8 2.8 2.8h.8l-2.8 6.4c-.4.8.2 1.6 1.2 1.6h4.4c.8 0 1.2-.4 1.2-1.2V9.2c0-.4-.4-.8-.8-.8h-.8c-2.8 0-5.2-2.4-5.2-5.2S9.2 0 12 0zm0 4.4c.8 0 1.6.8 1.6 1.6s-.8 1.6-1.6 1.6-1.6-.8-1.6-1.6.8-1.6 1.6-1.6z" />
  </svg>
)
const WhatsAppIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto flex flex-col items-center gap-10 py-16">
        ...
        >
          {[
            { href: 'https://linktr.ee/shinetechacademy', icon: <LinkTreeIcon />, label: 'Linktree' },
            { href: 'https://chat.whatsapp.com/IW45h51QyHsAPVTKWnBXro', icon: <WhatsAppIcon />, label: 'WhatsApp Community' },
